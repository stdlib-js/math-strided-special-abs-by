...
```javascript
import absBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-abs-by@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-abs-by@v0.1.0-deno/mod.js';
```
